...
def read_mentions(curl_request):
...
def collectParameters(consumerKey, oauthNonce, oauthToken, timeStamp, version, method):
	temp = ""
...
def authenticationAndSigning():
	...
	params = collectParameters(consumer_key, oauth_nonce, oauth_token, timeStamp, "1.0", "HMAC-SHA1")
...
def main():
	...
	curl_request = authenticationAndSigning()
	read_mentions(curl_request)
